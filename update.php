...
<body class="bg-secondary h-100">
    ...
    <!-- update current data -->
    <?php include 'scripts/update_Single.php'; ?>
        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-flex justify-content-center align-items-center" style="font-family: 'Volkhov', serif;">
                    <h1 class="float-left">Updating Item (<?php echo "{$id}"; ?>)</h1>
                </div>
            </div>
            <div class="card-body">
                <form method="post" enctype="multipart/form-data" action="">
                    ...
                    <div class="">
                        <br>
                        <h5>Item #: </h5>
                        <input type="text" class="form-control " name="_itemNumber"
                            value="<?php echo "{$_itemNumber}"; ?>">
                        </input>
                        <br>
                        <h5>Class: </h5>
                        <div class="input-group">
                            <select class="custom-select" id="inputGroupSelect04" name="_type">
                                <option value="<?php echo htmlspecialchars($_type, ENT_QUOTES); ?>" selected>
                                    <?php echo htmlspecialchars($_type, ENT_QUOTES); ?>
                                </option>
                    ...
                    <div class="">
                        ...
                        <textarea id="mytextarea1" class="" name="_scp"><?php echo $_scp; ?></textarea>
                    </div>
                    <div class="">
                        <br>
                        <script>
                        ...
                        <textarea id="mytextarea2" name="_description"><?php echo $_description; ?></textarea>
                    </div>
                    <br>
                    <div class="">
                        <label for=" file">
                    ...
                    <br>
                    <input type="submit" value="Update File" name="submit" class="btn btn-dark float-right">
                </form>
            </div>
        </div>
        <br>
    ...
    window.location = "index.php?action=updated";
    </script>
    <?php
    };
    ?>
